    ...
    <div className="min-h-screen flex items-center justify-center  text-white font-inter">
      <div className="w-full max-w-md p-6 bg-black/60 backdrop-blur-sm rounded-b-sm">
        <h2 className="text-2xl font-semibold mb-6 font-rubik">
          {isLogin ? 'Sign In' : 'Register'} to Voyagr
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-white text-black py-2 rounded hover:bg-pink-600 transition"
          >
        ...
        <div className="mt-6 text-center text-sm ">
          {isLogin ? (
            <>
              ...
              <button onClick={() => setIsLogin(false)} className="text-pink-500 hover:text-indigo-400 underline hover:scale-120 ml-2 transition font-rubik">
                Register
              </button>
            </>
          ) : (
